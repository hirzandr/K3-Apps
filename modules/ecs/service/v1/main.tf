# Modified from Reference: https://github.com/terraform-aws-modules/terraform-aws-ecs/tree/master
...
module "container_definition" {
  source = "../../container_definition/v1"
