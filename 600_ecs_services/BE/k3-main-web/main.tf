locals {
  name              = "prod-k3-main-web-iac"
  cluster_name      = "k3-cluster-ecs-iac"
  target_group_arn  = "arn:aws:elasticloadbalancing:ap-southeast-3:235494785181:targetgroup/k3-be-main-web-tg-iac/ebe124431dfac5e9"
...
resource "aws_ecs_task_definition" "k3" {
  container_definitions = jsonencode([
    {
      name         = local.name
      image        = "235494785181.dkr.ecr.ap-southeast-3.amazonaws.com/uat-k3-main-web:latest"
      cpu          = 0
      essential    = true
      logConfiguration = {
          logDriver = "awslogs"
